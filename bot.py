...
LETTER_TEXT = (
    "💌 Дорогая Алина,\n\n"
    "Сейчас ты читаешь это в первый раз или повторно. Но именно сегодня, 20.03.2026, поздравляю тебя с днём рождения 💐🩷🎂\n\n"
    "Желаю тебе всего самого наилучшего. Будь всегда здорова — и физически, и ментально. Живи в достатке, благополучии и комфорте. Счастья и безграничной любви! Пусть сбываются самые заветные мечты, даже те, которые пока кажутся несбыточными и далекими. Пусть рядом всегда будут люди, которые ценят тебя, понимают без слов и поддерживают в любую минуту.\n\n"
    "Ты — мой самый близкий и дорогой сердцу друг. Рядом с тобой солнце становится ярче, а мир словно замедляется. Хоть мы и не были так близки вначале, но теперь связь между нами прочная и крепкая. Уверена, что она не ослабнет, а будет только укрепляться. Очень хочу погулять на девичнике, отметить новоселье, поймать твой букет невесты, гулять вместе с колясками, обсуждать работу, путешествовать и собирать большие семейные вечера 🥹\n\n"
    "Никогда не вешай нос, не переживай по пустякам, не сдавайся! Это часто бывает сложно, но я в тебя верю. Ты большая молодец! Ты заслуживаешь всего самого лучшего, потому что твоё сердце способно любить глубоко и искренне, а душа — сопереживать и заботиться.\n\n"
    "Пусть этот солярный год станет для тебя годом расцвета, начинаний и удивительных встреч. Но главное — оставайся собой: такой же настоящей, нежной и прекрасной. Я бесконечно благодарна судьбе за то, что ты есть в моей жизни 🌟🙏\n\n"
    "В день твоего рождения вселенная стала богаче, ведь появилось такое сокровище — ты! Крепко обнимаю 💋\n\n"
    "С бесконечной любовью и благодарностью, твоя Алина Сергеевна 💗"
)
